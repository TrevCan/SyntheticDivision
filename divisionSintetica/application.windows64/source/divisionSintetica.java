...
public class divisionSintetica extends PApplet {
...
public String getAnswer(int initialExponent, int[] values, int[]firstLayer){
  String result = "\n";
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "divisionSintetica" };
    if (passedArgs != null) {
